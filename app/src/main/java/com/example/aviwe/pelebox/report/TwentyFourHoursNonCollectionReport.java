...
public class TwentyFourHoursNonCollectionReport extends AppCompatActivity implements MediPackClientsAdapter.MediPackClientsAdapterListener{
...
//    ReportAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twenty_four_hours_non_collection_report);
        ...
        mediPackList = helper.getTwentyfourHoursNonCollectedParcels();
